    ...
    Column(modifier = Modifier.padding(16.dp), horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        LazyColumn(state = listState,
            modifier = Modifier
                ...
                .fillMaxWidth()){items(questionSets) { item ->
            QuestionSetInfoComponent(questionBuilderViewModel = questionBuilderViewModel, questionSet = item)
        }}
        // Back button
